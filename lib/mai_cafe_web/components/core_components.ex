defmodule MaiCafeWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(MaiCafeWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(MaiCafeWeb.Gettext, "errors", msg, opts)
    end
  end
